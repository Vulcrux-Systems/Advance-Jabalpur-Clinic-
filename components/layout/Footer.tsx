          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 items-center">
                ...
                <a href={`mailto:${CLINIC.email}`} className="text-blue-100 hover:text-white text-sm transition-colors">info@advancedentaljabalpur.in</a>
              </div>
              <div className="flex gap-3 items-start">
              ...
              <div className="flex gap-3 items-center">
                ...
                <a href={`https://wa.me/${CLINIC.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-blue-100/80 hover:text-white text-sm transition-colors">WhatsApp</a>
              </div>
              <div className="flex gap-3 items-center">
                <Mail size={18} className="text-[#F26522] shrink-0" />
